...
eval_and_assert!(
    day13_secret,
    include_str!("day13.lf"),
    include_str!("inputs/day13-secret.txt"),
    equals(indoc! {r#"
        Part 1: 2305
        Part 2: 552612234243498
    "#}),
    empty()
);
...
eval_and_assert!(
    day16_secret,
    include_str!("day16.lf"),
    include_str!("inputs/day16-secret.txt"),
    equals(indoc! {r#"
        Part 1: 28884
        Part 2: ???
    "#}),
